...
class EpisodeReplayBuffer(Dataset):
    def __init__(self, state_dim, act_dim, data_path, scale=1000, K=20):
        self.device = "cpu"
    ...
    def __getitem__(self, index):
        ...
        s = traj['observations'][start_t: start_t + self.K] # K is max length of one sample
        ...
        return s, a, r, d, rtg, timesteps, mask, all_reward, curr_score, sn #all_reward：累计已获得奖励，curr_score: 当前得分（基于约束），sn：下一个状态
